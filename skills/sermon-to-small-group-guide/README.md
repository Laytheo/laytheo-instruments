...
- **Church name** — what your church is called (e.g., "Hulen Street Church")
- **Church location** — your city and state (e.g., "Fort Worth, Texas")
...
3. When you see the guide, take a moment to read it. If you want to change
   ...
   "add a question about prayer," "the pastor's name is Wes Hamilton, not
   what you guessed."
